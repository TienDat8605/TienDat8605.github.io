...
export const projects: ProjectProps[] = [
  {
    title: "Kompas",
    description:
      "AI-powered travel planning platform using GraphRAG for multimodal context understanding and personalized recommendations.",
  ...
  },
  {
    title: "Search Engine",
    description:
      "Semantic search engine with AI-generated summaries. Achieved 30% accuracy improvement over baseline.",
  ...
  },
  {
    title: "Medigent",
    description:
      "AI health assistant backend with service-layer architecture for scalable medical advice processing.",
  ...
  },
  {
    title: "FoodApp",
    description:
      "Real-time food ordering system with optimized database schema and order processing pipeline.",
  ...
  },
  {
    ...
    description:
      "Music visualizer inspired by NCS-style animated audio-reactive visuals.",
    tags: ["C", "Audio", "Visualizer"],
  ...
  },
  {
    ...
    description:
      "ML experiments on compressing models with distillation strategies for improved efficiency.",
